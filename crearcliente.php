<?php
 ...
 $nroCompras = $_REQUEST["nroCompras"];
 ...
 $guardar = $conexion->prepare("INSERT INTO clientes (id,cedula,nombre,nro_compras) VALUES (NULL,'$cedula','$nombre','$nroCompras')");
 $guardar->execute();
?>
...
<body>
    ...
    <section>
        ...
        <form class="formulario">
            <fieldset>
                <legend>Cliente guardado con éxito</legend>
                ...
                <div class="campo">
                    <label>Cédula: <?php echo $cedula;?> </label>
                </div>
                
                <div class="campo">
                    <label>Número de compras: <?php echo $nroCompras;?> </label>
                </div>
